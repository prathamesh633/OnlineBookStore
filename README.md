...
![onlinebookstore](onlinebookstore.png)
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/prathamesh633/OnlineBookStore.git```> Select master Branch > Next > Next > Finish.
...
Step 6: Check Running The Site At  <a href="http://localhost:8080/onlinebookstore/">http://localhost:8080/onlinebookstore/</a>
